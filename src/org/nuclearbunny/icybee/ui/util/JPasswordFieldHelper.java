/*
 * $Id: JPasswordFieldHelper.java,v 1.1 2004/01/25 03:05:19 dcgibbons Exp $
 *
 ...
 */
public class JPasswordFieldHelper extends JPasswordField {
    private JLabel defaultLabel;

    public JPasswordFieldHelper(ResourceBundle resources, String resourcePrefix) {
        super();
        init(resources, resourcePrefix);
    }

    public JPasswordFieldHelper(ResourceBundle resources, String resourcePrefix, String text) {
        super(text);
        init(resources, resourcePrefix);
    }
