/*
 * $Id: JComboBoxHelper.java,v 1.1 2004/02/01 01:33:25 dcgibbons Exp $
 *
...
/**
 * This extension of JComboBox will load various textual properties of the
 ...
 */
public class JComboBoxHelper extends JComboBox {
    private JLabel defaultLabel;

    public JComboBoxHelper(ResourceBundle resources, String resourcePrefix) {
        super();
        init(resources, resourcePrefix);
    }

    public JComboBoxHelper(ResourceBundle resources, String resourcePrefix, ComboBoxModel aModel) {
        super(aModel);
        init(resources, resourcePrefix);
    }

    public JComboBoxHelper(ResourceBundle resources, String resourcePrefix, Object[] items) {
        super(items);
        init(resources, resourcePrefix);
    }

    public JComboBoxHelper(ResourceBundle resources, String resourcePrefix, Vector items) {
        super(items);
        init(resources, resourcePrefix);
    }
