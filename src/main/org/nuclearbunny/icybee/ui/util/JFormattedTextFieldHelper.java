/*
 * $Id: JFormattedTextFieldHelper.java,v 1.1 2004/06/09 01:59:45 dcgibbons Exp $
 *
...
/**
 * This extension of JFormattedTextField will load various textual properties of the
 ...
 */
public class JFormattedTextFieldHelper extends JFormattedTextField {
    private JLabel defaultLabel;

    public JFormattedTextFieldHelper(ResourceBundle resources, String resourcePrefix) {
        super();
        init(resources, resourcePrefix);
    }

    public JFormattedTextFieldHelper(ResourceBundle resources, String resourcePrefix, Format format) {
        super(format);
        init(resources, resourcePrefix);
    }

    public JFormattedTextFieldHelper(ResourceBundle resources, String resourcePrefix, Object value) {
        super(value);
        init(resources, resourcePrefix);
    }
