/*
 * $Id: JSpinnerHelper.java,v 1.1 2004/02/01 05:07:31 dcgibbons Exp $
 *
...
/**
 * This extension of JSpinner will load various textual properties of the
 ...
 */
public class JSpinnerHelper extends JSpinner {
    private JLabel defaultLabel;

    public JSpinnerHelper(ResourceBundle resources, String resourcePrefix) {
        super();
        init(resources, resourcePrefix);
    }

    public JSpinnerHelper(ResourceBundle resources, String resourcePrefix, SpinnerModel model) {
        super(model);
        init(resources, resourcePrefix);
    }
